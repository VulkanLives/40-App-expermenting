...
#creating instances of buttons and label and canvas etc
    ...
    convertedString = int(userInput) #convert user string into int
    hello = "Hello ", convertedString
    confirmationClick = Label(root, text= hello) #display user entry
    confirmationClick.grid(row=25, column=20)
...
button2 = Button(root, text= "enter number", command=buttonClick2, fg=("blue"), bg=("red")) #"command" makes the calls the above function, fg is text colour "foreground" and Bg = background
# print the items from the above into window
